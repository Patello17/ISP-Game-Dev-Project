...
namespace ISP_Project.Game_States.Letters
{
    public class LetterTwo : State
    {
        ...
        public override void LoadState()
        {
            ...
            portraitTexture = Globals.ContentManager.Load<Texture2D>("Portraits/Duck Portrait");
        ...
        public override void Draw()
        {
            ...
            var textX = WindowManager.GetMainWindowCenter().X - 100 - (letterFont.MeasureString(letterText).X * letterFontSize / 2);
            ...
            var movesText = "Level 2 Completed in\n" + SaveManager.Load().LevelTwoFewestMoves + " moves.";
            var movesX = WindowManager.GetMainWindowCenter().X - 107 - (letterFont.MeasureString(movesText).X * letterFontSize / 2);
