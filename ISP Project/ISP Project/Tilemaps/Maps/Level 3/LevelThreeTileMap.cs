...
{
    public class LevelThreeTileMap : Tilemap
    {
        ...
        public LevelThreeTileMap(Vector2 position)
        {
            Transform.Position = position;
            level = LoadTileMap("../../../Tilemaps/Maps/Level 3/Level Three Tilemap_Level Map.csv");
            decorations = LoadTileMap("../../../Tilemaps/Maps/Level 3/Level Three Tilemap_Decorations.csv");
            collisions = LoadTileMap("../../../Tilemaps/Maps/Level 3/Level Three Tilemap_Collisions.csv");
            CollisionMap.SetMap(collisions);
        }

        public override void LoadContent()
        {
            levelTileset = Globals.ContentManager.Load<Texture2D>("Tilesets/Sandy Level Tileset");
